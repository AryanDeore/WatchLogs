...
// PROTOTYPE mock data — mirrors prototypes/menubar-layout/index.html's `DAILY`
// so the two prototypes stay comparable. "Today" = fictional Sat Aug 29 2026;
// the collapsed week row treats Aug 25 as "Monday" (fictional, not the real
// calendar) — same liberty the HTML prototype takes.
...
enum MockData {
    ...
    // shares the HTML prototype uses.
